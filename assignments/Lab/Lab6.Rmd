...
Our function performs Bootstrapping because it doesn't break any association between flipper length and species label. Entire rows are kept unjumbled, this tests the alternative hypothesis. 
...
There is no difference between the body mass of Adelie penguins versus Chinstrap penguins.

If Adelie and Gentoo penguins did not differ in body mass (i.e. the null hypothesis were true), and I repeatedly, and randomly, sampled individual Adelie and Chinstrap penguins from a population, I would expect to observe a difference in mean body mass of 32.4g or greater less than 1 in 1000 experiments.
